    ...
    for i in range(args.num_parts):
        ...
        for name in os.listdir(source_video_dir):
            ...
            for dir_type in os.listdir(name_video_dir):
                ...
                if len(list(filter(r.match, list(os.listdir(type_name_video_dir))))) > 0:
                    if len(list(os.listdir(type_name_video_dir))) < 5:
                        continue
                    ...
                    for emotion in os.listdir(type_name_video_dir):
                        ...
                        if len(list(os.listdir(emotion_video_dir))) < 5:
                            continue
