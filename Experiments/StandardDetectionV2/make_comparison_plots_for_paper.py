...
def parse_args():
    ...
    parser.add_argument('--results-dir', type=str, default='Adam method Results (14 IDs)',
                    help='Directory where results have been saved')

    parser.add_argument('--results-dir-base1', type=str, default='Mean feature method Results (14 IDs)',
                    help='Directory where baseline 1 results have been saved')

    parser.add_argument('--results-dir-base2', type=str, default='PCA method Results (14 IDs)',
