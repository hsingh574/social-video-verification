...
# Modified by Adam Pikielny, September 2020
...
#TODO: change to path of Wav2Lip
#deleted flags from v1: --mat, --results_dir, --bboxes (should we keep this one? wav2lip requires an int list instead of a file)
cd "${SCRIPT_LOCATION}../LipGAN/"

python inference.py --checkpoint_path logs/lipgan_best_residual.h5 --face "${VIDEO_LOCATION}cam1-lipgan/cam1-first-4k.mp4" --fps 29.97 --audio "audio/${AUDIO_FILENAME}.wav"
mv results/result_voice.mp4 "${VIDEO_LOCATION}cam1-lipgan/cam1-lipgan.mp4"

python inference.py --checkpoint_path logs/lipgan_best_residual.h5 --face "${VIDEO_LOCATION}cam2-lipgan/cam2-first-4k.mp4" --fps 29.97 --audio "audio/${AUDIO_FILENAME}.wav"
mv results/result_voice.mp4 "${VIDEO_LOCATION}cam2-lipgan/cam2-lipgan.mp4"

python inference.py --checkpoint_path logs/lipgan_best_residual.h5 --face "${VIDEO_LOCATION}cam3-lipgan/cam3-first-4k.mp4" --fps 29.97 --audio "audio/${AUDIO_FILENAME}.wav"
mv results/result_voice.mp4 "${VIDEO_LOCATION}cam3-lipgan/cam3-lipgan.mp4"

python inference.py --checkpoint_path logs/lipgan_best_residual.h5 --face "${VIDEO_LOCATION}cam4-lipgan/cam4-first-4k.mp4" --fps 29.97 --audio "audio/${AUDIO_FILENAME}.wav"
mv results/result_voice.mp4 "${VIDEO_LOCATION}cam4-lipgan/cam4-lipgan.mp4"

python inference.py --checkpoint_path logs/lipgan_best_residual.h5 --face "${VIDEO_LOCATION}cam5-lipgan/cam5-first-4k.mp4" --fps 29.97 --audio "audio/${AUDIO_FILENAME}.wav"
mv results/result_voice.mp4 "${VIDEO_LOCATION}cam5-lipgan/cam5-lipgan.mp4"

python inference.py --checkpoint_path logs/lipgan_best_residual.h5 --face "${VIDEO_LOCATION}cam6-lipgan/cam6-first-4k.mp4" --fps 29.97 --audio "audio/${AUDIO_FILENAME}.wav"
