...
do
    ...
    "${4}/wav2lip/bin/python3" inference.py --checkpoint_path "${5}" --face "${1}/camera{i}.mp4" --audio "${4}/audio/${6}.wav" --pads 40 10 15 15 --bboxFile "${1}/bounding-boxes/cam${i}-bounding-boxes.txt" 
